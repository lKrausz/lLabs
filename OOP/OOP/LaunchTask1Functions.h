...
void Hi()
{
 ...
 // Объявление и инициализация целочисленных переменных. Вывод их значения и суммы на экран.
void Summ()
{
	int a = 5;
	int b = 3;
...
// Вывод на экран результата деления двух целочисленных переменных со значениями 5 и 3 и двух вещественных переменных со значениями 5.0 и 3.0.
void Division()
{
	int a = 5;
	int b = 3;
...
// Демонстрация работы указателя, операций разыменования и взятия адреса. Вывод на экран адреса, хранимого в указателе и значения, которое хранится по данному адресу.
void Pointer()
{
	int value;
	int* pointer;
