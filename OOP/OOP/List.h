...
template <typename T>
class List //TODO: убрать слово Universal из названи€//done
{
	template <typename TItem>
	class ListItem //TODO: убрать слово Universal из названи€//done
	{
		TItem _value;
...
public:
	...
	void Show() //TODO: ѕросто Show. Ќе надо добавл€ть название класса в им€ методов а то вызов превращаетс€ в list.ShowList - тавтологи€//done
	{
		ListItem<T>* current = _head;
		if (_head == nullptr)
			return;
...
//TODO: если оператор перегружаетс€ дл€ класса Person, то этот код должен быть в классе Person, а не в списке//оно так не воркает
